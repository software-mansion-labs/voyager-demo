defmodule StationWeb.StationOpsLiveTest do
  ...
  test "the television carries the way in, as a code and as a line to type", %{conn: conn} do
    ...
    # The line under the code is wherever the endpoint says it is, minus the
    # scheme nobody types and every phone adds back on its own.
    url = StationWeb.Endpoint.url()
